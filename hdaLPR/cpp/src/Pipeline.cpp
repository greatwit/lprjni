...
namespace pr {
    ...
    PipelinePR::PipelinePR(std::string detector_filename,
        ...
        segmentationFreeRecognizer =  new SegmentationFreeRecognizer(segmentation_prototxt,segmentation_caffemodel);
    ...
    std::vector<PlateInfo> PipelinePR:: RunPiplineAsImage(cv::Mat plateImage,int method) {
        ...
        plateDetection->plateDetectionRough(plateImage,plates,36,280);
